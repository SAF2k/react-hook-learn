    ...
    <>
      <div className="flex justify-center h-screen p-6 bg-gradient-to-b from-orange-300 to-red-400">
        <div className="flex justify-center flex-col items-center gap-[50px] h-[calc(100vh-50px)] w-[calc(100vw-510px)] bg-gradient-to-r from-slate-900 to-slate-700 text-white rounded-full">
          <h1 className="text-5xl font-bold">Use State With Safety</h1>
          <div className="text-4xl flex items-center border rounded-xl ">
            <button
              className="border shadow-sm px-4 rounded-l-xl"
              onClick={decrementFive}
            >
              -5
            </button>
            <button className="border px-4" onClick={decrementOne}>
              -
            </button>
            <span className="px-4">{count}</span>
            <button className="border px-4" onClick={incrementOne}>
              +
            </button>
            <button
              className="border shadow-sm px-4 rounded-r-xl"
